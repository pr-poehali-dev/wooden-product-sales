...
const PRODUCTS = [
  {
    id: 1,
    name: "Менажница «Ясень»",
    desc: "Трёхсекционная доска из светлого ясеня. Природный рисунок волокон, масло-воск покрытие.",
    price: "2 800 ₽",
    tag: "Хит",
    img: HERO_IMG,
    wood: "Ясень",
  },
  {
    id: 2,
    name: "Менажница «Орех»",
    desc: "Двухсекционная подача из тёмного ореха. Благородный цвет, идеально для подачи блюд.",
    price: "3 500 ₽",
    tag: "Новинка",
    img: COLLECTION_IMG,
    wood: "Орех",
  },
  {
    id: 3,
    name: "Менажница «Дуб»",
    desc: "Классика из дуба с глубоким рисунком. Прочность и долговечность на годы.",
    price: "3 200 ₽",
    tag: "",
    img: WORKSHOP_IMG,
    wood: "Дуб",
  ...
  {
    id: 4,
    name: "Менажница «Вишня»",
    desc: "Розово-красный оттенок вишни, изысканная подача. Ограниченная серия.",
    price: "3 800 ₽",
    tag: "Лимитед",
    img: HERO_IMG,
    wood: "Вишня",
...
const PORTFOLIO_ITEMS = [
  { img: HERO_IMG, title: "Менажница из ясеня", size: "30×20 см" },
  { img: COLLECTION_IMG, title: "Подача из ореха", size: "35×15 см" },
  { img: WORKSHOP_IMG, title: "Мастерская", size: "" },
  { img: HERO_IMG, title: "Доска из дуба", size: "40×25 см" },
  { img: COLLECTION_IMG, title: "Набор из берёзы", size: "25×18 см" },
  { img: WORKSHOP_IMG, title: "Авторский лоток", size: "32×22 см" },
];
