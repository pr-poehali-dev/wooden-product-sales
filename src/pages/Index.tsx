...
const PRODUCTS = [
  {
    ...
    desc: "Круглая менажница для сервировки и подачи. Массив дуба, 4 секции + соусник по центру. Обработана специальным маслом.",
    price: "900 ₽",
    tag: "Хит",
  ...
  },
  {
    id: 2,
    name: "Столик винный",
    desc: "Винный столик со встроенной менажницей. Массив дуба, складные ножки, высота 12,5 см. Эффектный подарок.",
    price: "4 500 ₽",
    tag: "Подарок",
